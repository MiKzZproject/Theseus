...
$evenements = $controlEvenement->getEventsByProductPagination($page,$idProduit);
$eventsCount = $controlEvenement->getEventsByProductCount($idProduit);
        ...
        if(!empty($evenements)) {
            foreach ($evenements as $evenement) {
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="" class="bloc-event <?php echo $state; ?>" data-toggle="modal"
                       data-target="#myModal<?php echo $evenement->getId(); ?>">
                ...
                <div class="modal fade modal-event" id="myModal<?php echo $evenement->getId(); ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel"><?php echo $evenement->getLibelle(); ?>
                                    - <?php echo $startDate; ?></h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <p>
                                    <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Lieu
                                    : <?php echo $evenement->getLieu(); ?><br/>
                                    ...
                                    : <?php echo $evenement->getAdresse(); ?>
                                    - <?php echo $evenement->getCp(); ?> <?php echo $evenement->getVille(); ?><br/>
                                    <span class="glyphicon glyphicon-headphones" aria-hidden="true"></span> Produits
                                    : <?php echo $evenement->getTheme(); ?><br/>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" data-id="<?php echo $evenement->getId(); ?>"
                                        class="btn btn-primary subscribeEvent">S'inscrire à l'évènement
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="my-id<?php echo $evenement->getId(); ?>" class="uk-modal">
                        <div class="uk-modal-dialog uk-modal-dialog-lightbox">
                            <a href="<?php echo $evenement->getImage(); ?>"
            ...
            <div class="container">
                <div class="alert alert-info" role="alert"><p>Aucun évènement ne correspond à votre recherche</p></div>
            </div>
            <?php
        }
        ?>
