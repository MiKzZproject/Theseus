...
<div id="events-content">
    ...
    <div class="modal fade modal-event" id="myModal<?php echo $evenement->getId(); ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-footer">
                    ...
                    <?php
                        if($logged) {
                            ...
                            $client = $_SESSION['login'];
                            if ($controlEvenement->isSubscribed($evenement->getId(), $client->getId())) {
                                ?>
                                <button type="button" data-id="<?php echo $evenement->getId(); ?>"
                                        class="btn btn-danger unSubscribeEvent">Se désinscrire de l'évènement
                                </button>
                                <?php
                            } else {
                                ?>
